<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConvTechnical.aspx.cs" Inherits="ConvTechnical" %>
...
<head runat="server">
    <meta charset="utf-8"/>
	<title>Activities >> Social Technical</title> 
			    		...
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
									...
									<li ><a href="ConvSemWork.aspx">Seminars & Workshops</a></li>
									<li ><a href="ConvSocial.aspx">Social Activities</a></li>
			              			<li class="active nav-bar-content-x" ><a href="ConvTechnical.aspx">Technical Events</a></li>
