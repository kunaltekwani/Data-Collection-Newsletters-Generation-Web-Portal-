<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Achievement.aspx.cs" Inherits="Student_Achievement" %>
...
<head runat="server">
   <meta charset="utf-8">
	<title>Achievement1 >>Student_Achievment</title> 
	...
	<header>
			    		...
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
			              			...
			              			<li class=""><a href="Book.aspx">Book Publications</a></li>
									<li class=""><a href="Conference.aspx">Conference Articles</a></li>
			              			<li class=""><a href="Journal.aspx">Journal Articles</a></li>
                                    <li class="active nav-bar-content-x"><a href="Student_Achievement.aspx">Student Achievement</a></li>
     ...
     <br />			
      ...
      <li align="left"><h2><u><b class="back"><a href="Achievements.aspx">Go to Main Achievement Page</a></b></u></h2></li></ul>
        ...
        BorderWidth="1px" OnRowCommand="OnRowCommandClick5"
        ...
        <Columns>
          ...
          <asp:TemplateField>
           ...
           <asp:TemplateField>
             <HeaderTemplate >
                  <b class="abc">Programme</b>
             </HeaderTemplate>
             <ItemTemplate >
                <asp:Label runat="server" ID="lblId" Text='<%#Eval("Programme")%>' Font-Size="Medium" />
             </ItemTemplate>
             <EditItemTemplate >
                 <asp:TextBox ID="txtpg" runat="server" Text='<%#Eval("Programme")%>'></asp:TextBox>
             </EditItemTemplate>
             <FooterTemplate >
          ...
          <asp:TemplateField>
             <HeaderTemplate >
              <b class="abc">Category</b>
             </HeaderTemplate>
             <ItemTemplate >
                <asp:Label runat="server" ID="lblname" Text='<%#Eval("Category")%>' Font-Size="Medium" />
             </ItemTemplate>
              <EditItemTemplate >
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lblDetails" Text='<%#Eval("Level") %>' Font-Size="Medium" />
             </ItemTemplate>
              <EditItemTemplate >
                 <asp:TextBox ID="txtlevel" runat="server" Text='<%#Eval("Level") %>' TextMode="MultiLine" Rows="1"></asp:TextBox>
                  
             </EditItemTemplate>
             <FooterTemplate >
                 <asp:TextBox ID="txtlevel" runat="server" TextMode="MultiLine" Rows="1"></asp:TextBox>
            ...
            <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lblevent" Text='<%#Eval("Event") %>'  Font-Size="Medium"/>
             </ItemTemplate>
              <EditItemTemplate >
                 <asp:TextBox ID="txtevent" runat="server" Text='<%#Eval("Event") %>' ></asp:TextBox>
            ...
            <asp:TemplateField>
             <HeaderTemplate >
              <b class="abc">Name of Students</b>
             </HeaderTemplate>
             <ItemTemplate >
                <asp:Label runat="server" ID="lblNos" Text='<%#Eval("Name_of_students") %>'  Font-Size="Medium"/>
             </ItemTemplate>
              <EditItemTemplate >
                 <asp:TextBox ID="txtname" runat="server" Text='<%#Eval("Name_of_students") %>' ></asp:TextBox>
            ...
            <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lblprice" Text='<%#Eval("Rank") %>'  Font-Size="Medium"/>
             </ItemTemplate>
              <EditItemTemplate >
                 <asp:TextBox ID="txtrank" runat="server" Text='<%#Eval("Rank") %>' ></asp:TextBox>
            ...
            <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lbldate5" Text='<%#Eval("date") %>'  Font-Size="Medium"/>
             </ItemTemplate>
              <EditItemTemplate >
