<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Journal.aspx.cs" Inherits="Journal" %>
...
<head runat="server">
     <meta charset="utf-8">
	<title>Achievement1 >>Journal</title> 
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
									...
									<li class=""><a href="Conference.aspx">Conference Articles</a></li>
			              			<li class="active nav-bar-content-x"><a href="Journal.aspx">Journal Articles</a></li>
        ...
        <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtName" runat="server" Text='<%#Eval("Faculty_Name")%>' Width="300px"></asp:TextBox>
             </EditItemTemplate>
             <FooterTemplate >
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtDetails" runat="server" Text='<%#Eval("Details") %>' TextMode="MultiLine" Rows="1" Width="650px"></asp:TextBox>
                  
             </EditItemTemplate>
             <FooterTemplate >
                 <asp:TextBox ID="txtDetails" runat="server" TextMode="MultiLine" Rows="1" Width="650px"></asp:TextBox>
