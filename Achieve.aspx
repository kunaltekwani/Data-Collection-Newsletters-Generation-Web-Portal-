<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Achieve.aspx.cs" Inherits="Achieve" %>
...
<head runat="server">
     <meta charset="utf-8">
	<title>Achievement1 >>Achievments</title> 
  ...
  <div>
	...
	<header>
			    		...
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
			              			...
			              			<li class="active nav-bar-content-x" ><a href="Achieve.aspx">Achievements</a></li>
      ...
      <li align="left"><h2><u><b class="back"><a href="Achievements.aspx">Go to Main Achievement Page</a></b></u></h2></li></ul>
        ...
        BorderWidth="1px" OnRowCommand="OnRowCommandClick1"
        ...
        <Columns>
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtAName" runat="server" Text='<%#Eval("Faculty_Name")%>' Width="300px"></asp:TextBox>
             </EditItemTemplate>
             <FooterTemplate >
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtADetails" runat="server" Text='<%#Eval("Details") %>' TextMode="MultiLine" Rows="1" Width="650px"></asp:TextBox>
                  
             </EditItemTemplate>
             <FooterTemplate >
                 <asp:TextBox ID="txtADetails" runat="server" TextMode="MultiLine" Rows="1" Width="650px"></asp:TextBox>
            ...
            <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lbldate1" Text='<%#Eval("date") %>'  Font-Size="Medium"/>
             </ItemTemplate>
              <EditItemTemplate >
             ...
             <FooterTemplate >
                 ...
                 <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtTnD" OnClientDateSelectionChanged="checkDate"/>
             </FooterTemplate>
          </asp:TemplateField>
