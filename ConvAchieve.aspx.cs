...
public partial class ConvAchieve : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        try
        {
            ...
            cmd.CommandText = "select Achievements_id,Categories,Faculty_name,Details,status,Convert(Varchar(20),date,101) as date, Users.username from Achievements, Users where Categories = 'Achievement' and Achievements.faculty = Users.id";
    ...
    protected void OnRowCommandClick1(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("xInsert"))
        {
            ...
            name = ((TextBox)GridView1.FooterRow.FindControl("txtAName")).Text;
            Details = ((TextBox)GridView1.FooterRow.FindControl("txtADetails")).Text;
            ...
            if (name.Equals("") || Details.Equals("") || fac.Equals("") || TnD.Equals("") || fac.Equals(""))
            {
            ...
            else
            {
                ...
                cmd.CommandText = "insert into Achievements(Faculty_Name,Categories,Details,faculty,status,date) values ( '" + name + "','Achievement','" + Details + "','" + facx + "','" + status + "','" + TnD + "')";
        ...
        else if (e.CommandName.Equals("xUpdate"))
        {
            ...
            fac = ((TextBox)GridView1.Rows[index].Cells[7].Controls[1]).Text;
            status = ((CheckBox)GridView1.Rows[index].Cells[8].Controls[1]).Checked;
    ...
    protected void Filter_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "select Achievements_id,Categories,Faculty_name,Details,status,Convert(Varchar(20),date,101) as date, Users.username from Achievements, Users where Categories = 'Achievement' and Achievements.faculty = Users.id and date between '" + fromDate + "' and '" + toDate + "'";
                adp = new SqlDataAdapter(cmd);
                ds = new DataSet();
                adp.Fill(ds);
                GridView1.DataSource = ds.Tables[0];
