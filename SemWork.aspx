<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SemWork.aspx.cs" Inherits="SemWork" %>
...
<head id="Head1" runat="server">
    <meta charset="utf-8">
	<title>Activities >> Seminar & Workshop</title> 
					...
					<div class="navbar navbar-inverse navbar-fixed-top ">
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
			              			<li class="" ><a href="Cultural.aspx">Cultural Events</a></li>
			              			<li class=""><a href="Industrial.aspx">Industrial Visit</a></li>
									<li class="active nav-bar-content-x"><a href="SemWork.aspx">Seminars & Workshops</a></li>
        ...
        <Columns>
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtDetails" runat="server" Text='<%#Eval("Details") %>' TextMode="MultiLine" Rows="2" Width="440px"></asp:TextBox>
             </EditItemTemplate>
             <FooterTemplate >
          ...
          <asp:TemplateField>
            ...
            <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lblTnD" Text='<%#Eval("Time_and_Date") %>' Font-Size="Medium" />
             </ItemTemplate>
              <EditItemTemplate >
