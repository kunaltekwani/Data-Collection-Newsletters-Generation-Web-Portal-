...
public partial class Technical : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        cmd.CommandText = "select Activity_id,Activity_Name,Categories,Details,Place,Convert(Varchar(20),Time_and_Date,101) as Time_and_Date, status from Activities where Categories = 'Technical'"; //and faculty = '" + Session["uname"].ToString() + "'";
    ...
    protected void OnRowCommandClick(object sender, GridViewCommandEventArgs e)
    {
                ...
                try
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "insert into Activities(Activity_Name,Categories,Details,Place,Time_and_Date,faculty) values ('" + name + "','Technical','" + Details + "','" + Place + "','" + TnD + "','" + Session["uname"].ToString() + "')";
