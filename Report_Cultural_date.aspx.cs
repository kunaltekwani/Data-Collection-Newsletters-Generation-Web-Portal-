...
public partial class Report_Cultural_date : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rd.Load(Server.MapPath("~") + "\\App_Data\\Report_Cultural_date.rpt");
        rd.SetDataSource(ds);
