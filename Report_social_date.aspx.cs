...
public partial class Report_social_date : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rd.Load(Server.MapPath("~") + "\\App_Data\\Report_social_date.rpt");
        rd.SetDataSource(ds);
