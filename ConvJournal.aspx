<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConvJournal.aspx.cs" Inherits="ConvJournal" %>
...
<head runat="server">
    <meta charset="utf-8">
	<title>Achievement >>Achievments</title> 
...
<body>
	...
	<header>
			    		...
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
									...
									<li class=""><a href="ConvConference.aspx">Conference Articles</a></li>
			              			<li class="active nav-bar-content-x" ><a href="ConvJournal.aspx">Journal Articles</a></li>
      ...
      <li align="left"><h2><u><b class="back"><a href="ConvAchievements.aspx">Go to Main Achievement Page</a></b></u></h2></li></ul>
        ...
        BorderWidth="1px" OnRowCommand="OnRowCommandClick4"
        ...
        <Columns>
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtJName" runat="server" Text='<%#Eval("Faculty_Name")%>'></asp:TextBox>
             </EditItemTemplate>
             <FooterTemplate >
                 <asp:TextBox ID="txtJName" runat="server"></asp:TextBox>
             </FooterTemplate>
          </asp:TemplateField>
          ...
          <asp:TemplateField>
             ...
             <ItemTemplate >
              ...
              <EditItemTemplate >
                 <asp:TextBox ID="txtJDetails" runat="server" Text='<%#Eval("Details") %>' TextMode="MultiLine" Rows="1"></asp:TextBox>
                  
             </EditItemTemplate>
             <FooterTemplate >
                 <asp:TextBox ID="txtJDetails" runat="server" TextMode="MultiLine" Rows="1"></asp:TextBox>
            ...
            <asp:TemplateField>
             ...
             <ItemTemplate >
                <asp:Label runat="server" ID="lbldate4" Text='<%#Eval("date") %>'  Font-Size="Medium"/>
             </ItemTemplate>
              <EditItemTemplate >
                 <asp:TextBox ID="txtTnD" runat="server" Text='<%#Eval("date") %>' width="100px"></asp:TextBox>
                  <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtTnD"  />
             </EditItemTemplate>
             <FooterTemplate >
                 <asp:TextBox ID="txtTnD" runat="server" width="100px"></asp:TextBox>
                 <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtTnD" />
             </FooterTemplate>
          </asp:TemplateField>
