...
public partial class Journal : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        cmd.CommandText = "select Achievements_id,Categories,Faculty_name,Details,status,Convert(Varchar(20),date,101) as date from Achievements where Categories = 'Journal'"; //and faculty = '" + Session["uname"].ToString() + "'";
    ...
    protected void OnRowCommandClick4(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.Equals("xInsert"))
        {
            ...
            name = ((TextBox)GridView4.FooterRow.FindControl("txtName")).Text;
            Details = ((TextBox)GridView4.FooterRow.FindControl("txtDetails")).Text;
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into Achievements(Categories,Faculty_Name,Details,date) values ( 'Journal','" + name + "', '" + Details + "','" + TnD + "')";  // ,faculty     '" + Session["uname"].ToString() + "',
